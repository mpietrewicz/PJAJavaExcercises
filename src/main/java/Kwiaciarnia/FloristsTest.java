...
public class FloristsTest {
 ...
 /*<- tu trzeba wpisac kod metody */
    ...
    public static void main(String[] args) {
        ...
        // W takim arzie zostałyby usunięte z wózka i Janek nie płaciłb
        y za nie
        // Również może mu zabraknąc pieniędzy, wtedy też kwaity są odk
        ładane.
        ...
        // Zobaczmy jaka jest wartość czerwonych kwiatów w pudełku Jank
        a
